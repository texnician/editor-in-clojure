...
(defmonster :id 1 :name "史莱姆1号" :level 3 :hp 300 :mp 800  :species SLIME
  ...
  :speed 1 :mental 5 :dodge-rate 2000 :crit-rate 1500 :magic-resistance [1 2 3])
...
(defmonster :id 2 :name "机器人" :level 10 :hp 1000 :mp 1000 :species "METAL" 
  ...
  :speed 4 :mental 6 :dodge-rate 2500 :crit-rate 2000 :magic-resistance [])
...
(defmonster :level 5 :id 4 :name "XXX" :hp 500 :mp 500 :species DEMON
  :monster-rank SS :generation 8 :summon-cost 3 :attack 40 :defence 100
  :speed 3 :mental 10 :dodge-rate 2000 :crit-rate 1000 :magic-resistance [80])
